  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={{ color:"#888", marginTop:0 }}>Just a few more details</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input style={styles.input} name="address"
            ...
            onChange={handleChange} />
          <input style={styles.input} name="avatar"
            placeholder="Avatar URL (optional)" value={form.avatar}
            onChange={handleChange} />
          <button style={styles.button} type="submit">Save & Continue</button>
        </form>
      </div>
    </div>
  )
